...
const Main = () => {
	...
	const [showDash, set_showDash] = useState(false); //set true to false to test interview room
	...
	const [showInterview, set_showInterview] = useState(true); //set false to true to test interview room
	const [interviewEdit, set_interviewEdit] = useState(false);
	const [showInterviewCreate, set_showInterviwCreate] = useState(false)
	const [interviewId, set_interviewId] = useState(123); //set null to a random number to test interview room
